<template>
  <div class="md-layout md-alignment-center">
    ...
    <div class="md-layout-item md-size-95">
      <md-content class="md-layout md-gutter" style="backgrund: #007998; padding: 1em;">
        <ul v-for="headline in headlines" :key="headline.id" class="md-layout-item md-large-size-25 md-medium-size-33 md-small-size-50 md-small-size-100">
